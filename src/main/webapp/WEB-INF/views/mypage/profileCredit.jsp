	...
	<div class="real-content-container">
		<div class="mp-container">
			...
			<div class="mypage-body">
				<div>
					<div class="credit-apply-btn-space">
				...
				<div class="promo-title-image-container">
					<img src="${pageContext.request.contextPath }/resources/images/확성기1.png" alt="" class="promo-title-image" />
				</div>
				...
				<div class="row">
					<div class="col-xs-6 col-xs-offset-3">
						<div class="row">
							<a class="col-xs-4" ng-click="trackButton('facebook_promotion_share')" si-facebook-invite="" url="http://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.withsellit.com%2Finvite%2Fjptd%3Fs%3Dsfb">
							...
							<!-- 트위터는 제외 -->
							<!-- 
							<a class="col-xs-4" ng-click="trackButton('twitter_promotion_share')" si-twitter-invite="" url="http://twitter.com/intent/tweet?text=셀잇 엄청 편리하네요! 안쓰는 물건은 꼭 셀잇으로 판매해보세요. 지금 제 프로모션 코드(jptd)로 물건을 판매하면 10,000원 할인 쿠폰을 드린대요:)&amp;url=https%3A%2F%2Fwww.withsellit.com%2Finvite%2Fjptd%3Fs%3Dstw">
								<div class="promo-share-icon">
									<img alt="Share twitter a1e3f3bdcaf374125ecacbd34c500028dc6d80285b31f94a95ff487aa9ded97e" src="/assets/share_twitter-a1e3f3bdcaf374125ecacbd34c500028dc6d80285b31f94a95ff487aa9ded97e.png">
								</div>
								<div class="promo-share-desc">
									트위터
								</div>
