...
<div id="board-container">
	<input type="text" class="form-control" placeholder="제목" name="boardTitle" id="boardTitle" value="${board.boardTitle }" readonly required>
    ...
    <textarea class="form-control" name="boardContent" placeholder="내용" readonly required>${board.boardContent }</textarea>
</div>
