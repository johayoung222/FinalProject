...
.box-link1 {
	border-ight: 1px solid lightgray;
	float: right;
	width: 7%;
	height: 40px;
	text-align: center;
	...
	<div id="container">
		<div id="box-link">
			...
			<div class="box-link2">
				...
				<c:if test="${memberLoggedIn != null }">
					<a class="item-link" onfocus="blur()" id="button_"
						data-toggle="collapse" data-target="#collapseExample"
						aria-expanded="false" aria-controls="collapseExample"> 마이페이지▼
					</a>
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						<div>
							<a class="dropdown-item"
								href="${pageContext.request.contextPath }/item/item.do">핸드폰</a>
