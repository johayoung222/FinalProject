...
<div class="row">
  <div class="col-3">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link" id="v-pills-sellPutin-tab"  href="${pageContext.request.contextPath}/admin/regist.do" role="tab" aria-controls="v-pills-sellPutin" aria-selected="false" title="판매 신청 리스트">판매 신청 리스트</a>
      ...
      <a class="nav-link" id="v-pills-QA-tab"  href="${pageContext.request.contextPath}/admin/QA.do" role="tab" aria-controls="v-pills-QA" aria-selected="false" title="1:1질문 답변">1:1질문 답변</a>
