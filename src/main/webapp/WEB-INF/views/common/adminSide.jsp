...
<div id="container2">
  <div class="col-2">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link" id="v-pills-productList-tab"  href="${pageContext.request.contextPath}/admin/productList.do" role="tab" aria-controls="v-pills-productList" aria-selected="false" title="상품 리스트">판매 상품 리스트</a>
